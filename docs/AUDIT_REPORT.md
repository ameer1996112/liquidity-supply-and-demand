...
| `frontend/.next/dev/logs/*.log` | Frontend | Next.js dev logs      |
...
- `frontend/` - Separate Next.js frontend
...
_This report was generated automatically. Always review before executing cleanup actions._
