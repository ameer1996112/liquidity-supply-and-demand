...
```bash
debugger_model=$(node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.windsurf/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-debugger --raw)
```
