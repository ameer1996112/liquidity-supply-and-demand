...
- Usage: Reference from command with `@/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
