...
- **Global scope**: `/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/notes/`)
...
2. Glob `/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.gemini/notes/` — works in any directory
