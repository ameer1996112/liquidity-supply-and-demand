          ...
          <MetricCard
            ...
            value={
              account.margin_level_pct != null
                ? `${account.margin_level_pct.toFixed(1)}%`
                : 'N/A'
            }
            valueColor={
      ...
      <section className='tv-card p-4'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-5 gap-4'>
          <MetricCard
            ...
            valueColor={
              account.win_rate >= 0.5 ? 'text-[#26a69a]' : 'text-[#ef5350]'
            }
          />
          <MetricCard
            label='Profit Factor'
            value={
              account.profit_factor != null && account.profit_factor > 0
          ...
          <MetricCard
            label='Sharpe Ratio'
            value={
              account.sharpe_ratio && account.sharpe_ratio !== 0
        ...
        <section className='rounded-lg border border-amber-500/30 bg-amber-500/5 px-4 py-3 flex items-center gap-3'>
          ...
          <div>
            ...
            <div className='text-xs text-amber-600/80 mt-0.5'>
              This account is currently paused. Resume trading from the Accounts
              table.
            </div>
          </div>
        </section>
      ...
      {account.account_type === 'Eval' && (
        <section className='rounded-lg border border-blue-500/30 bg-blue-500/5 px-4 py-3'>
          ...
          <div className='text-xs text-blue-400/80'>
            💡 Evaluation progress tracking coming soon. This will show profit
            target, drawdown limits, and trading days.
          </div>
        </section>
      )}
    </div>
