...
export function DashboardView({ accountName, hideHeader }: DashboardViewProps) {
  ...
  const { data: stats, isLoading: statsLoading } = useSignalStats(accountName);
  ...
  const { data: signals = [], isLoading: signalsLoading } =
    useTradingSignals(activeMode, accountName);
