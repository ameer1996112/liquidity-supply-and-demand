  ...
  if (data.length < 2) {
    return (
      <div className="tv-card flex items-center justify-center" style={{ height }}>
        <span className="text-xs text-zinc-600 font-mono">Not enough data for equity curve</span>
      </div>
    );
  }
  ...
  return (
    <div className="tv-card p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className={`font-mono text-sm font-bold tabular-nums ${isPositive ? 'text-[#26a69a]' : 'text-[#ef5350]'}`}>
