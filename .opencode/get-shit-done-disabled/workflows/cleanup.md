...
```bash
node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
