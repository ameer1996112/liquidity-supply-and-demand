...
```bash
INIT=$(node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
