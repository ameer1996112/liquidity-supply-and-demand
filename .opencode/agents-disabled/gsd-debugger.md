...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode
                  → checks /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done
                  → writes to /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/hooks/
...
@/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
