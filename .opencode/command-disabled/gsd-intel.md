...
Intel system is disabled. To activate:
  ...
  node /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/ameeramer/dev/projects/galilsoftware/sources/trading/.opencode/get-shit-done/bin/gsd-tools.cjs
